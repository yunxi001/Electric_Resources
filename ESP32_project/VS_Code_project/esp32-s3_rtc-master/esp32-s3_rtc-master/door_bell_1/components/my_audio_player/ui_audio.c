...
void my_audio_init(file_iterator_instance_t *i)
{
    file_iterator = i;
    g_sys_volume = 80;
...
void ui_audio_start(file_iterator_instance_t *i)
{
    ...
    lv_obj_t *btn_play_pause = lv_btn_create(guider_ui.screen);
    ...
    lv_obj_t *btn_play_prev = lv_btn_create(guider_ui.screen);
    ...
    lv_obj_t *btn_play_next = lv_btn_create(guider_ui.screen);
    ...
    lv_obj_t *volume_slider = lv_slider_create(guider_ui.screen);
    ...
    lv_slider_set_range(volume_slider, 0, 200);
