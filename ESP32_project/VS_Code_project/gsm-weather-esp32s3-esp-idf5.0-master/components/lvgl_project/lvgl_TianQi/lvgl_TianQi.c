...
void lvgl_TianQi_Set_ChengShi(char *str)
{
	...
	if (lvgl_TianQi_ChengShiMing_text == NULL)
	{
		...
		lv_obj_add_style(lvgl_TianQi_ChengShiMing_text, LV_OBJ_PART_MAIN, &lvgl_font16_style);
...
void lvgl_TianQi_create(lv_obj_t * Fu)
{
	...
	if (lvgl_TianQi_main_cont == NULL)
	{
		...
		lvgl_TianQi_Set_ChengShi(lvgl_globa_text[56][system_get_Language()]);
	...
	lvgl_task_create(&lvgl_TianQi_task,lvgl_TianQi_TaskCb, 1000, LV_TASK_PRIO_HIGH, NULL);
