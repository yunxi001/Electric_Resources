...
//----标题----//
		...
		lv_style_copy(&SheZhi_ChuangKou.label_BiaoTi_style, &lvgl_font_ZiDing_K8_24_style);
...
//----标题----//
		...
		for (i = 0; i < SheZhi_Button_Num; i++)
		{
			...
			lv_style_set_text_font(&lvgl_SheZhi_Button_style[i], LV_STATE_DEFAULT, (const lv_font_t*)&font_ZiDing_K8_24);
		...
		lvgl_task_create(&SheZhi_ChuangKou.lvgl_task,lvgl_SheZhi_TaskCb, 200, LV_TASK_PRIO_HIGH, NULL);
