...
//----标题----//
		...
		lv_style_copy(&SheZhi_yuyan_ChuangKou.label_BiaoTi_style, &lvgl_font_ZiDing_K8_24_style);
...
//----选中时的背景----//
		...
		for (i = 0; i < SheZhi_yuyan_Button_Num; i++)
		{
			...
			lv_style_set_text_font(&lvgl_SheZhi_yuyan_Button_style[i], LV_STATE_DEFAULT, (const lv_font_t*)&font_ZiDing_K8_24);
	...
	lvgl_task_create(&lvgl_SheZhi_yuyan_task,lvgl_SheZhi_yuyan_TaskCb, 100, LV_TASK_PRIO_HIGH, NULL);
